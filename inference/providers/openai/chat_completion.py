    ...
    def stream_handle_function_calls(
        ...
        if delta and delta.get("tool_calls"):
            ...
            if toll_call_index == function_calls_content.index:
                function_calls_content.arguments_strs[function_calls_content.index] += tool_call_function["arguments"] or ""
                ...
                function_calls_content.names.append(tool_call_function.get("name") or "")
