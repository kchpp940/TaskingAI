...
class MessageGenerationLog(BaseModel):
    ...
    status: Optional[str] = Field(None, description="The status of the event: start, success, error.")
    duration_ms: Optional[int] = Field(None, ge=0, description="Duration of the event in milliseconds.")
    input_summary: Optional[str] = Field(None, description="Summary of the input for quick preview.")
    error: Optional[Dict[str, Any]] = Field(None, description="Error information if status is error.")
